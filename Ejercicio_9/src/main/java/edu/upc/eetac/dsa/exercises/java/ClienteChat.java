...
public class ClienteChat implements Runnable {
    ...
    public ClienteChat(String server) {
        this(server, ServerChat.DEFAULT_PORT);
    }

    public ClienteChat(String server, int port) {
        this.server = server;
        this.port = port;
    }
    ...
    public static void main(String[] args) {
        ...
        ClienteChat client = new ClienteChat(server, port);
